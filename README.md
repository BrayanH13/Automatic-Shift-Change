...
## 3. **Automatic-Shift-Change** (Público)  
### Introducción  
Programa que automatiza el proceso de **entrega de turno** en un NOC, extrayendo incidencias y ventanas de mantenimiento desde **Jira** y generando un resumen en archivo de texto.  
